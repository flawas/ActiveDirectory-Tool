...
$ActiveDirectoryTool             = New-Object system.Windows.Forms.Form
$ActiveDirectoryTool.ClientSize  = New-Object System.Drawing.Point(550,393)
$ActiveDirectoryTool.text        = "Active Directory Tool"
$ActiveDirectoryTool.TopMost     = $false
...
$SetPassword.location            = New-Object System.Drawing.Point(200,99)
...
$GetLastLogon                    = New-Object system.Windows.Forms.Button
$GetLastLogon.text               = "Get Last Logon"
$GetLastLogon.width              = 100
$GetLastLogon.height             = 30
$GetLastLogon.location           = New-Object System.Drawing.Point(200,161)
$GetLastLogon.Font               = New-Object System.Drawing.Font('Microsoft Sans Serif',8)

$ActiveDirectoryTool.controls.AddRange(@($CheckLocked,$User,$Header,$UnlockAccount,$LockAccount,$Header2,$Password,$SetPassword,$DIsableAccount,$EnableAccount,$GetLastLogon))
...
$GetLastLogon.Add_Click({ GetLastLogon })
...
function GetLastLogon {
    $Result = Get-ADUser -Identity $User.Text -Properties LastLogonDate | select LastLogonDate
